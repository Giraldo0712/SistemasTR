...
// Límites de temperatura para los LEDs
static float blue_led_value_min  = 0.0;
static float blue_led_value_max  = 24.9;

static float green_led_value_min = 25.0;
static float green_led_value_max = 35.0;

static float red_led_value_min   = 35.1;
static float red_led_value_max   = 100.0;
